...
namespace Business.Concrete
{
       ...
       
    {
        ...
        public IDataResult<List<FakeCard>> GetByUserId(int id)
        {
            return new SuccessDataResult<List<FakeCard>>(_fakeCardDal.GetAll(c => c.UserId == id), Messages.FakeCardsListed);
        }
